...
> $castigliano$를 적용하면, 
> $$
> \theta = \int^{l}_{0} \frac{(-R_{A}\ x + M_{A})}{EI}\cdot 1 \, dx \\
...
>
> $$
> \delta = \int^{l}_{0} \frac{(-R_{A}\ x + M_{A})}{EI}\cdot x \, dx \\
> = \frac{1}{EL} \left[ \frac{R_{A}}{3}x^{3} - \frac{M_{A}}{2}x^{2} \right] _{0}^{l} \\
> = \frac{1}{EL} \left[ \frac{R_{A}}{3}l^{3} - \frac{M_{A}}{2}l^{2} \right] \\
> = \frac{1}{EL} \left[ \frac{R_{A}}{3}l^{3} - \frac{R_{A}}{4}l^{3} \right] = \frac{R_{A}\ l^{3}}{12EI} \\
> \to R_{A} = \frac{12EI}{l^{3}} \delta = -R_{B}\\
> M_{A} = \frac{6EI}{l^{3}} \delta = M_{B}
> $$
>
> 
>
